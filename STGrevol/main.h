...
Startmode_select startmode_select(&define_srsize.enlargement_factor, &loadgr.startgr, 220, TITLEMEN_BASIC_PLACE_Y, 0, 0, 0.0, &titlemenue_system.select_menue_var, 0);
Exitmode_select exitmode_selsct(&define_srsize.enlargement_factor, &loadgr.exitgr, 220, TITLEMEN_BASIC_PLACE_Y, 0, 0, 0.0, &titlemenue_system.select_menue_var, 1);