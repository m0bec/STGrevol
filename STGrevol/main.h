...
Keyconmode_select keyconmode_select(&define_srsize.enlargement_factor, &loadgr.manualgr, TITLEMEN_BASIC_PLACE_X, TITLEMEN_BASIC_PLACE_Y, 0, 0, 0.0, &titlemenue_system.select_menue_var, KEYCON_MENUE_NUMBER, &loadgr.keycon_num, &loadgr.exitgr);