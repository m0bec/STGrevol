...
Manualmode_select manualmode_select(&define_srsize.enlargement_factor, &loadgr.keycongr, TITLEMEN_BASIC_PLACE_X, TITLEMEN_BASIC_PLACE_Y, 0, 0, 0.0, &titlemenue_system.select_menue_var, MANUAL_MENUE_NUMBER);
Keyconmode_select keyconmode_select(&system_control.system_var, &define_srsize.enlargement_factor, &loadgr.manualgr, TITLEMEN_BASIC_PLACE_X, TITLEMEN_BASIC_PLACE_Y, 0, 0, 0.0, &titlemenue_system.select_menue_var, KEYCON_MENUE_NUMBER, &loadgr.keycon_num, &loadgr.exitgr, &joypad_control.shot_flag);